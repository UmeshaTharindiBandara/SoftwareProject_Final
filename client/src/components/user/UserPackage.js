    ...
    <div>
        ...
        >
          {[...areas, ...newAreas].map((area, index) => (
            <Card
              key={index}
              className={`area-card ${
                selectedArea === area ? "area-card-selected" : ""
              }`}
          ...
          <Card
            className="area-card add-new-area-card"
      ...
      {selectedArea && (
        <div>
          ...
          >
            {[...(selectedArea.locations || []), ...newLocations].map(
              (location, index) => (
                <Card
                  key={index}
            ...
            <Card
              className="location-card add-new-location"
              style={{ width: "200px" }}
            >
              <CardContent className="location-content">
                <TextField
