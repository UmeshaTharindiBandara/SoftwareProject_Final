...
const AddPackages = () => {
  ...
  ["Activity Add-ons", activities, setActivities, activityBudgets, setActivityBudgets],
  ["Optional Destinations", optionalDestinations, setOptionalDestinations, optionalDestinationBudgets, setOptionalDestinationBudgets],
  ["Transport Modes", transportModes, setTransportModes, transportModeBudgets, setTransportModeBudgets],
  ["Guide Selections", guides, setGuides, guideBudgets, setGuideBudgets],
  ["Hotel Selections", hotels, setHotels, hotelBudgets, setHotelBudgets]
